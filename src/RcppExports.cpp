...
RcppExport SEXP _fcindex_CIndex(SEXP yhatSEXP, SEXP ySEXP, SEXP statusSEXP, SEXP wSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_fcindex_CIndex", (DL_FUNC) &_fcindex_CIndex, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_fcindex(DllInfo *dll) {
